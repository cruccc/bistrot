  ...
  <div class= "container-fluid">
    ...
    <div class="row riga1" style="padding:15px 0px">
      ...
      <div class="col-md-7 col-sm-8">
        ...
        <!-- Container per la galleria-->
        <div class="carousel-container">

          <!-- Immagine superiore e numero corrente -->
          <div class="mySlides">
          ...
          <hr style="opacity: 0; margin: 7.5px 0px">

          <!-- Bottoni avanti e dietro -->
          <a class="prev" style="text-decoration: none; padding:8px" onclick="plusSlides(-1)">&#10094;</a>
          <a class="next" style="text-decoration: none; padding:8px" onclick="plusSlides(1)">&#10095;</a>
